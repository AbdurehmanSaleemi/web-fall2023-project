...
const Header = () => {
    ...
    const onClickOfLink = (route) => {
        // get current route
        const currentRoute = window.location.pathname;
        if(currentRoute !== '/'){
            // append current route with # and route
    ...
    return (
        ...
        >
            ...
            >
                ...
                {!token ? <NavItem onClick={() => onClickOfLink('features')}route='#features' linkName={'Features'} /> : <NavItem route='/profile' linkName={'Profile'} />}
                {!token && <NavItem onClick={() => onClickOfLink('features')} route="#pricing" linkName={'Pricing'} /> }
